...
const showRecipe = async function() {
    try {
        ...
        _recipeViewDefault.default.renderError(err);
    }
};
async function showSearchResult() {
    try {
        ...
        // debugger;
        _recipeViewDefault.default.renderError(err.message);
    }
}
function controlPagination(page) {
    _resultsViewDefault.default.render(_model.getSearchResultsPage(page));
    _paginationViewDefault.default.render(_model.state.search);
}
...
const init = function() {
    _bookMarksViewDefault.default.addBookMarkHandler(controlBookmarks);
    _recipeViewDefault.default.addHandlerRenderer(showRecipe);
    _searchViewDefault.default.addHandlerSearch(showSearchResult);
...
},{"core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","../img/icons.svg":"cMpiy","./views/recipeView":"l60JC","./views/searchView":"9OQAM","./views/resultsView":"cSbZE","./views/paginationView":"6z7bi","./views/BookMarksView":"4agqx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/addRecipeView":"i6DNj","./config":"k5Hzs"}],"49tUX":[function(require,module,exports) {
...
const loadSearchResults = async function(query) {
    try {
        let srchUrl = `https://forkify-api.herokuapp.com/api/v2/recipes?search=${query}&key=${_config.KEY}`;
        let data = await _helper.AJAX(srchUrl);
        console.log(data);
...
},{"./config":"k5Hzs","regenerator-runtime/runtime":"dXNgZ","./views/helper":"eA19p","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const KEY = `c5d26582-7a98-405d-ae1c-fefa8e15af80`;
...
},{"../config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cMpiy":[function(require,module,exports) {
...
class RecipeView extends _viewDefault.default {
    ...
    _errorMessage = `Encountered an error. Please try again!!!`;
    _message = ``;
    _generateMarkup() {
        ...
        <div class="recipe__ingredients">
            ...
            <div class="recipe__quantity">${ingredient.quantity ? _fractyDefault.default(ingredient.quantity).toString() : ''}</div>
...
},{"../../img/icons.svg":"cMpiy","fracty":"hJO4d","./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJO4d":[function(require,module,exports) {
...
class PaginationView extends _viewDefault.default {
    ...
    _generateMarkup() {
        ...
        const numPages = Math.ceil(this._data.results.length / _config.RESULTS_PER_PAGE);
        console.log(curPage);
        ...
        if (curPage < numPages) //other page
        return `<button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
              <use href="${_iconsSvgDefault.default}.svg#icon-arrow-left"></use>
            </svg>
...
},{"./view":"bWlJ9","../config":"k5Hzs","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4agqx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
